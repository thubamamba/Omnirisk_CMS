module User::Authenticatable
  ...
  included do
    ...
    devise(*[:database_authenticatable, :registerable, :recoverable, :rememberable, :validatable, :confirmable, :lockable, :trackable, (:omniauthable if defined? OmniAuth)].compact)
